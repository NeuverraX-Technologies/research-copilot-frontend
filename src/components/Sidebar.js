// src/components/Sidebar.js - With Custom Alert
        ...
        <div className="p-6 border-t border-gray-700">
          ...
          <div className="mt-4 pt-4 border-t border-gray-700">
            ...
            <div className="flex gap-3 mt-2 text-xs">
              <a href="https://neuverrax.com/terms-of-service.html" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">Terms</a>
              <a href="https://neuverrax.com/privacy-policy.html" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">Privacy</a>
              <a href="mailto:support@neuverrax.com" className="text-gray-400 hover:text-white transition">Help</a>
            </div>
          </div>
        </div>
      </div>
